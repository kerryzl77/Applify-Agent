...
class LLMGenerator:
    ...
    def _build_cover_letter_prompt(self, job_data, candidate_data):
        ...
        "Write ONLY the body paragraphs of the cover letter (no header or contact information). End with 'Best regards,' followed by a new line and then the candidate's name."
        """