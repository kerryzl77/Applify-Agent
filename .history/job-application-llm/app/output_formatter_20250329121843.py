...
class OutputFormatter:
    def __init__(self):
        ...
        self.normal_font_size = Pt(11)  # Slightly smaller than default
        self.margin_size = Inches(0.8)  # Reduced margins
    ...
    def format_text(self, content, content_type):
        ...
        if content_type == 'linkedin_message':
            ...
            # Reduce maximum words to ensure one-page fit
            words = content.split()
            if len(words) > 350:  # Reduced from 370
    ...
    def create_docx(self, content, job_data, candidate_data, content_type):
        ...
        try:
            ...
            # Set smaller margins for all sections
    ...
    def _format_cover_letter_docx(self, doc, content, job_data, candidate_data):
        ...
        try:
            # Add candidate info at the top with compact formatting
            candidate_info = doc.add_paragraph()
            candidate_info.alignment = WD_ALIGN_PARAGRAPH.LEFT
            candidate_info.paragraph_format.space_after = Pt(0)
            ...
            # Split content into paragraphs and add them with compact formatting
            ...
            # Add signature with minimal spacing
